...
{
	static_assert( ColsAtCompileTime != Dynamic && RowsAtCompileTime != Dynamic, "w() can only be called on static-sized vector types");
...
{
	static_assert(ColsAtCompileTime != Dynamic && RowsAtCompileTime != Dynamic, "setW() can only be called on static-sized vector types");
