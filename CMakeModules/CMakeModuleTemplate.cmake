...
list(APPEND INCLUDED_HEADERS ${UNKNOWN_ENGINE_SOURCE_DIR}/ComponentInterfaces/include)
list(APPEND INCLUDED_HEADERS ${UNKNOWN_ENGINE_SOURCE_DIR}/ResourceTypesDefinitions)
...
foreach(SOURCE_WILDCARD ${SOURCES_WILDCARD})
	list(APPEND ADOPTED_SOURCES_WILDCARD ${SRC_DIR}/${SOURCE_WILDCARD})
	list(APPEND ADOPTED_SOURCES_WILDCARD ${INCLUDE_DIR}/${SOURCE_WILDCARD})
	foreach(ADDITIONAL_SOURCE_DIR ${ADDITIONAL_SOURCE_DIRS})
		list(APPEND ADOPTED_SOURCES_WILDCARD ${ADDITIONAL_SOURCE_DIR}/${SOURCE_WILDCARD})
	endforeach()
endforeach(SOURCE_WILDCARD)

file(GLOB_RECURSE SRC_FILES ${ADOPTED_SOURCES_WILDCARD})
file(GLOB_RECURSE INCLUDE_FILES ${ADOPTED_SOURCES_WILDCARD})

list(APPEND SOURCES ${SRC_FILES} ${INCLUDE_FILES})

if(NOT ___PCH_INCLUDE___)
	set(___PCH_INCLUDE___ ${UNKNOWN_ENGINE_SOURCE_DIR}/${TARGET_NAME}/stdafx.h)
endif()

if(NOT ___PCH_SOURCE___)
	set(___PCH_SOURCE___ ${UNKNOWN_ENGINE_SOURCE_DIR}/${TARGET_NAME}/stdafx.cpp)
endif()


if(EXISTS ${___PCH_SOURCE___} AND EXISTS ${___PCH_INCLUDE___})
	list(APPEND SOURCES ${___PCH_SOURCE___})
endif()
...
if(DEPLOY_INCLUDES)
	if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/include)
		install(DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/include DESTINATION ${INCLUDE_DEPLOY_DIR}/${TARGET_NAME})
...
list(APPEND MODULES_TO_BUILD "${TARGET_NAME}")
