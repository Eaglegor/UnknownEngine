...
namespace UnknownEngine
{
	namespace Behavior
	{
		...
		public:
			...
			{
				int result;
				result = script_engine->RegisterObjectMethod(getRegisteredName(), "Loader::IDataProvider@ createDataProvider(const Loader::DataProviderDesc &in)", asMETHOD(Core::ResourceManager, createDataProvider), asCALL_THISCALL);
